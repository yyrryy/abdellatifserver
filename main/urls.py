...
urlpatterns = [
    ...
    path('makecommandnotsent', views.makecommandnotsent, name='makecommandnotsent'),
    path('getnumberofnewitems', views.getnumberofnewitems, name='getnumberofnewitems'),
    path('validerclientcart', views.validerclientcart, name='validerclientcart'),
